          ...
          <div className="flex justify-between items-end border-b border-[#e2bfb0]/30 dark:border-white/5 pb-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=50" className="w-6 h-6 rounded-full border border-white dark:border-[#0c1322] object-cover" alt="Avatar" />
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=50" className="w-6 h-6 rounded-full border border-white dark:border-[#0c1322] object-cover" alt="Avatar" />
              </div>
              <span className="text-[11px] font-extrabold text-[#5a4136] dark:text-[#e2bfb0] bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/40 dark:border-white/10 px-3 py-1 rounded-full">{jobs.length} Active Matches</span>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="space-y-4 flex-1 w-full">
                    <div className="flex items-start gap-5">
                      <div className="w-14 h-14 rounded-2xl bg-white/50 dark:bg-white/5 border border-[#e2bfb0]/50 dark:border-white/10 text-[#a04100] dark:text-[#ffb693] font-black text-xl flex items-center justify-center flex-shrink-0">
                        {job.company ? job.company[0] : 'C'}
                      </div>
                      <div className="space-y-1">
                        <h3 className="font-extrabold text-xl text-[#261812] dark:text-white leading-snug">{job.title}</h3>
                        <p className="text-xs text-[#5a4136] dark:text-[#e2bfb0] font-bold">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="px-4 py-1.5 rounded-full bg-white/50 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/10 text-[#a04100] dark:text-[#ffb693] font-extrabold text-xs">
                    ...
                    <div className="flex flex-wrap gap-2 pt-1">
                      {job.required_skills?.map((skill, i) => (
                        <span key={i} className="px-3.5 py-1.5 rounded-xl bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/5 text-[11px] font-bold text-[#5a4136] dark:text-[#e2bfb0]">
                          {skill}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center text-center flex-shrink-0 px-6 py-2">
                    <div className="w-16 h-16 rounded-full border-4 border-[#ff6b00] dark:border-[#ffb693] flex items-center justify-center font-black text-base text-[#a04100] dark:text-white bg-white/30 dark:bg-white/5 shadow-md">
                      {job.match_score || job.match_percentage || 94}%
                    </div>
                    <span className="text-[9px] font-black uppercase text-[#ff6b00] dark:text-[#ffb693] tracking-widest mt-2.5">NEURAL MATCH</span>
                  </div>

                  {/* Right Action Buttons */}
                  <div className="flex flex-col gap-2.5 flex-shrink-0 w-full md:w-40 border-t md:border-t-0 md:border-l border-[#e2bfb0]/20 dark:border-white/5 pt-4 md:pt-0 md:pl-6">
                    <button
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="reference-card p-6 space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3.5 rounded-2xl bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/5 text-xs font-bold hover:scale-[1.01] transition-transform cursor-pointer">
                <span className="text-[#261812] dark:text-white">Generative AI Lead</span>
                <span className="px-2.5 py-0.5 rounded-full bg-[#ff6b00] dark:bg-[#ffb693] text-white dark:text-[#561f00] text-[9px] font-black uppercase tracking-wider">3 NEW</span>
              </div>
              <div className="flex justify-between items-center p-3.5 rounded-2xl bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/5 text-xs font-bold hover:scale-[1.01] transition-transform cursor-pointer">
                <span className="text-[#5a4136] dark:text-[#e2bfb0]">Data Infrastructure</span>
                <span className="px-2.5 py-0.5 rounded-full bg-slate-200 dark:bg-white/10 text-[#78716C] dark:text-[#e2bfb0] text-[9px] font-black uppercase tracking-wider">0 NEW</span>
              </div>
            </div>
          </div>
          ...
          <div className="reference-card p-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-2 text-xs font-bold">
              ...
              <span className="px-3.5 py-2 rounded-xl bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/5 text-[#5a4136] dark:text-[#e2bfb0] hover:border-[#ff6b00] transition-colors cursor-pointer">Vector DBs</span>
              <span className="px-3.5 py-2 rounded-xl bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/5 text-[#5a4136] dark:text-[#e2bfb0] hover:border-[#ff6b00] transition-colors cursor-pointer">Kubernetes</span>
              <span className="px-3.5 py-2 rounded-xl bg-white/40 dark:bg-white/5 border border-[#e2bfb0]/30 dark:border-white/5 text-[#5a4136] dark:text-[#e2bfb0] hover:border-[#ff6b00] transition-colors cursor-pointer">On-Device Inference</span>
            </div>
          </div>
