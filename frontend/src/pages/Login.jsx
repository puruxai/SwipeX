    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <button
          ...
          className="w-full py-2.5 px-4 glass-panel text-sm font-semibold text-slate-500 rounded-xl flex items-center justify-center gap-2 border border-white/10 cursor-not-allowed"
        >
